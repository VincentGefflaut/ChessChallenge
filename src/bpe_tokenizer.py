...
class ChessTokenizer(PreTrainedTokenizer):
    ...
    def build_vocab_from_dataset(
        ...
        """
        Build a tokenizer vocabulary using Byte-Pair Encoding (BPE).
        
        Args:
            dataset_name: Name of the dataset on Hugging Face Hub.
            split: Dataset split to use.
            column: Column containing the game strings.
            vocab_size: Target vocabulary size (default: 1000).
            max_samples: Maximum number of samples to process (default: 100k).
        Returns:
            A ChessTokenizer with BPE-built vocabulary.
        """
        ...
        # Save games to temporary file for BPE training
        ...
        try:
            ...
            # Extract vocabulary from trained tokenizer
